...
/// <summary>Design-time category accents retained by the DEV-040 compact-card preview.</summary>
...
public sealed class TaskCardViewModel : ObservableObject
{
    ...
    /// <summary>
    /// Initializes a legacy design-preview card. It remains completion-disabled and has no
    ...
    /// <summary>Gets the accent used for the legacy category preview.</summary>
